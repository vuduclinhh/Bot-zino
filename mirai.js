    ...
    login(loginData, async(loginError, loginApiData) => {
      ...
      (async function () {
        while (true) {
          ...
          if (time == `${hour}:00:00`) {
            const res = (await axios.get("https://nguyentantairandom.tan-taitai10.repl.co/getlink2")).data.data;
...
(async() => {
 ...
 console.log(chalk.bold.hex("#eff1f0").bold("\n=====================================================================\n━                                                                   ━\n━                               \n███╗░░░███╗██████╗░██████╗░███████╗███╗░░██╗\n████╗░████║██╔══██╗██╔══██╗██╔════╝████╗░██║\n██╔████╔██║██████╔╝██████╦╝█████╗░░██╔██╗██║\n██║╚██╔╝██║██╔══██╗██╔══██╗██╔══╝░░██║╚████║\n██║░╚═╝░██║██║░░██║██████╦╝███████╗██║░╚███║\n╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═════╝░╚══════╝╚═╝░░╚══╝ \n   ━\n━       * Information about me                                      ━\n━                                                                   ━\n━       * Mirai V2 - Version: 1.2.14                                ━\n━       * Bot Mod By: Nguyen Thanh Loc                                   ━\n━       * Run And Bot Management: Nguyen Thanh Loc             ━\n━     * Zalo: 03xxxxxxx2                                          ━\n━   * Facebook: Nguyen Thanh Loc               ━\n━       * Gmail:ntl.designer@yahoo.com                               ━\n━                                                                   ━\n━                                                                   ━\n=====================================================================\n"));
