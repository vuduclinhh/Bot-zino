...
module.exports.run = async function({ api, args, event, permssion }) {
  ...
  if(args[0] == "find" || args[0] == "tìm"){
    ...
    const msg = ({
    body: `𝗖𝗵𝗮𝗿 𝗺𝗮𝗻𝗴 𝘀𝗼̂́ 𝘁𝗵𝘂̛́ 𝘁𝘂̛̣ ${args[1]} 🌸`,
    attachment: t
  })
    return api.sendMessage(msg, event.threadID, event.messageID)
  }
  if(!args[0]){
  const abcxyz = ["https://i.imgur.com/rV86W2q.jpg","https://i.imgur.com/vr5yehF.jpg","https://i.imgur.com/IAMxgBx.jpg","https://i.imgur.com/vhNDnFP.jpg"]
  let o = [];
  for(let i = 0; i < 4; i++){
  ...
  const msg = ({
    body: "🌸==[ 𝐂𝐎𝐕𝐄𝐑 𝐀𝐍𝐈𝐌𝐄 ] ==🌸\n\n𝗥𝗲𝗽𝗹𝘆 𝗧𝗶𝗻 𝗡𝗵𝗮̆́𝗻 𝗩𝗮̀ 𝗖𝗵𝗼̣𝗻 𝗞𝗶𝗲̂̉𝘂 𝗠𝗮̀ 𝗕𝗮̣𝗻 𝗧𝗵𝗶́𝗰𝗵 𝗧𝗮̣𝗼 𝗔̉𝗻𝗵",
    attachment: o
  })
...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
  ...
  if (handleReply.author != event.senderID) return api.sendMessage('Cút', event.threaID);
  ...
  if (!fs.existsSync(__dirname + `/tad/MTD William Letter.otf`)) {
    let getfont3 = (await axios.get(`https://github.com/kenyrm2250/font/raw/main/MTD%20William%20Letter.otf`, { responseType: "arraybuffer" })).data;
  ...
  if (!fs.existsSync(__dirname + `/tad/SteelfishRg-Regular.otf`)) {
    let getfont4 = (await axios.get(`https://github.com/kenyrm2250/font/raw/main/SteelfishRg-Regular.otf`, { responseType: "arraybuffer" })).data;
  ...
  if (!fs.existsSync(__dirname + `/tad/SVN-BigNoodleTitling.otf`)) {
    let getfont5 = (await axios.get(`https://github.com/kenyrm2250/font/raw/main/SVN-Big%20Noodle%20Titling.otf`, { responseType: "arraybuffer" })).data;
  ...
  if (handleReply.step == 1) {
    ...
    api.unsendMessage(handleReply.messageID);
    return api.sendMessage(`𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗰𝗵𝗼̣𝗻 𝘁𝗲̂𝗻 𝗰𝗵𝗶́𝗻𝗵 𝗹𝗮̀ ${event.body} 𝗿𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗮̀ 𝗻𝗵𝗮̣̂𝗽 𝘁𝗲̂𝗻 𝗽𝗵𝘂̣ 🌸`, threadID, function(err, info) {
      return global.client.handleReply.push({
        step: 4,
        name: "coveralime",
        author: senderID,
    ...
    api.unsendMessage(handleReply.messageID);
    return api.sendMessage(`𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗰𝗵𝗼̣𝗻 𝘁𝗲̂𝗻 𝗽𝗵𝘂̣ 𝗹𝗮̀ ${event.body}, 𝗿𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗮̀ 𝗰𝗵𝗼̣𝗻 𝗺𝗮̀𝘂 ( 𝗵𝗮̃𝘆 𝗴𝗵𝗶 𝗻𝗼 𝗻𝗲̂́𝘂 𝗯𝗮̣𝗻 𝗺𝘂𝗼̂́𝗻 𝗱𝘂̀𝗻𝗴 𝗺𝗮̀𝘂 𝘁𝗿𝘂𝘆𝗲̂̀𝗻 𝘁𝗵𝗼̂́𝗻𝗴 )`, threadID, function(err, info) {
      return global.client.handleReply.push({
        step: 5,
        name: "coveralime",
        author: senderID,
