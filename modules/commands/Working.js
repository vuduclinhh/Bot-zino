...
var coinscn = Math.floor(Math.random() * 50000) + 20000; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 50000) + 20000; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 50000) + 20000; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 50000) + 20000; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 50000) + 20000; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 60000) + 20000; //random coins khi đào đá

//random công việc cần làm
var rdcn = ['tuyển dụng nhân viên', 'quản trị khách sạn', 'tại nhà máy ��iện', 'đầu bếp trong nhà hàng', 'công nhân']; //random công việc khi làm ở khu công nghiệp
