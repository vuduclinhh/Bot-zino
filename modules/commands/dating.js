...
module.exports.run = async function({ api, event, args, Users, Currencies }) {
    ...
    switch (args[0]) {
        ...
        case "breakup":
            ...
            if (!userInfo.data.dating || userInfo.data.dating && userInfo.data.dating.status == false) return api.sendMessage(`𝐁𝐚̣𝐧 𝐜𝐡𝐮̛𝐚 𝐡𝐞̣𝐧 𝐡��̀ 𝐯𝐨̛́𝐢 𝐚𝐢 𝐭𝐡𝐢̀ 𝐜𝐡𝐢𝐚 𝐭𝐚𝐲 𝐜𝐚́��� 𝐠𝐢̀ ?`, threadID, messageID);
